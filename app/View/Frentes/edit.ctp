...
<?php echo $this->Form->create('Frente'); ?>
	<fieldset>
		<legend><?php echo __('Edit Frente'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Frente.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Frente.id'))); ?></li>
